...
namespace GlobalBarcodeHook
{
    class BarCodeHook
    {
        ...
        [DllImport("user32.dll", CharSet = CharSet.Unicode, EntryPoint = "GetKeyNameText")]
        private static extern int GetKeyNameText(int lParam, StringBuilder lpBuffer, int nSize);

        [DllImport("user32.dll", CharSet = CharSet.Auto, EntryPoint = "GetKeyboardState")]
        private static extern int GetKeyboardState(byte[] pbKeyState);

        [DllImport("user32.dll", CharSet = CharSet.Auto, EntryPoint = "ToAscii")]
